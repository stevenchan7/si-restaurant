    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Djantaurant</div>
            </a>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <div class="tenor-gif-embed" data-postid="6124504793129675429" data-share-method="host"
                    data-aspect-ratio="1.33333" data-width="100%"><a
                        ...
                        Sticker</a>from <a href="https://tenor.com/search/shocked+face-stickers">Shocked Face
                        Stickers</a></div>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <!-- Dropdown - Alerts -->
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in notifications"
